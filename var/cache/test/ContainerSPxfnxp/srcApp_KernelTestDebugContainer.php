...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    protected function getServicesResetterService()
    {
        ...
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'form.choice_list_factory.cached' => [0 => 'reset'], 'mailer.logger_message_listener' => [0 => 'reset'], 'profiler' => [0 => 'reset'], 'debug.validator' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'debug.event_dispatcher' => [0 => 'reset'], 'monolog.handler.main' => [0 => 'reset'], 'doctrine' => [0 => 'reset'], 'form.type.entity' => [0 => 'reset'], 'security.token_storage' => [0 => 'disableUsageTracking', 1 => 'setToken'], 'cache.security_expression_language' => [0 => 'reset']]);
    }
    ...
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'browser-kit'.\DIRECTORY_SEPARATOR.'Client.php';
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'http-kernel'.\DIRECTORY_SEPARATOR.'Client.php';
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Client.php';
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\PatientRepository' => ['privates', 'App\\Repository\\PatientRepository', 'getPatientRepositoryService', false],
     ...
     */
    protected function getPatientRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\PatientRepository'] = new \App\Repository\PatientRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('N3GatUPHgz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0pqrhBOHYg', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mUsn4V9ask', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z89ZuOzVqn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ptmBQJlVsJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DzUe0R60Qt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LI6T1gYbFj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder7d814 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer02ea8 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties51c3d = [
        
    ];

    public function getConnection()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getConnection', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getMetadataFactory', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getExpressionBuilder', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'beginTransaction', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getCache', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getCache();
    }

    public function transactional($func)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'transactional', array('func' => $func), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->transactional($func);
    }

    public function commit()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'commit', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->commit();
    }

    public function rollback()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'rollback', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getClassMetadata', array('className' => $className), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'createQuery', array('dql' => $dql), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'createNamedQuery', array('name' => $name), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'createQueryBuilder', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'flush', array('entity' => $entity), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'clear', array('entityName' => $entityName), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->clear($entityName);
    }

    public function close()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'close', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->close();
    }

    public function persist($entity)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'persist', array('entity' => $entity), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'remove', array('entity' => $entity), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'refresh', array('entity' => $entity), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'detach', array('entity' => $entity), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'merge', array('entity' => $entity), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getRepository', array('entityName' => $entityName), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'contains', array('entity' => $entity), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getEventManager', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getConfiguration', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'isOpen', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getUnitOfWork', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getProxyFactory', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'initializeObject', array('obj' => $obj), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'getFilters', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'isFiltersStateClean', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'hasFilters', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return $this->valueHolder7d814->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer02ea8 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder7d814) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder7d814 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder7d814->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, '__get', ['name' => $name], $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        if (isset(self::$publicProperties51c3d[$name])) {
            return $this->valueHolder7d814->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder7d814;
    ...
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;
    ...
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, '__isset', array('name' => $name), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;
    ...
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, '__unset', array('name' => $name), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;
    ...
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, '__clone', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        $this->valueHolder7d814 = clone $this->valueHolder7d814;
    }

    public function __sleep()
    {
        $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, '__sleep', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;

        return array('valueHolder7d814');
    }
    ...
    {
        $this->initializer02ea8 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer02ea8;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer02ea8 && ($this->initializer02ea8->__invoke($valueHolder7d814, $this, 'initializeProxy', array(), $this->initializer02ea8) || 1) && $this->valueHolder7d814 = $valueHolder7d814;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder7d814;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder7d814;
    }
}
